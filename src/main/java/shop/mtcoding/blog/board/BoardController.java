...
public class BoardController {
    ...
    public String update(@PathVariable int id, BoardRequest.UpdateDTO requestDTO, HttpServletRequest request, @AuthenticationPrincipal MyLoginUser myLoginUser) {
    ...
    public String index(HttpServletRequest request, @AuthenticationPrincipal MyLoginUser myLoginUser) {
        System.out.println("로그인 되었니? : " + myLoginUser.getUsername());
        List<Board> boardList = boardRepository.findAll();
        request.setAttribute("boardList", boardList);
...
//       값이 null 이 아니면, /board/saveForm 으로 이동
    ...
    public String detail(@PathVariable int id, HttpServletRequest request, @AuthenticationPrincipal MyLoginUser myLoginUser) {
        ...
        if (myLoginUser == null) {
            ...
            int loginId = myLoginUser.getUser().getId();
